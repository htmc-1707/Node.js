...
import { addToCart } from '../../Service/CartSV';
...
const Modal = ({ show, onClose, product }) => {
  ...
  const handleAddToCart = async () => {
    ...
    try {
      ...
      if (token) {
        // Người dùng đã đăng nhập, gọi API thêm vào yêu thích
        ...
        console.log('Thêm vào yêu thích local thành công');
      }
      ...
      setError('Có lỗi xảy ra khi thêm vào yêu thích. Vui lòng thử lại.');
    } finally {
      setIsLoading(false);
    }
  };
        ...
        <div className="modal-body">
          ...
          <div className="modal-details">
            ...
            <div className="product-options">
              ...
              <button className="add-to-cart" onClick={handleAddToCart}>Thêm vào yêu thích</button>
            </div>
